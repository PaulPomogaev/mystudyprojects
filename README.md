...
<div align="center">
  <img src="https://github.com/user-attachments/assets/39738078-89b3-4b3e-b98e-55842b35b813" alt="Программирование в Visual Studio">
  <br>
...
- **C# 9.0** (ООП, события, работа с классами и наследованием)
...
🔑 Ключевые слова
C# | ООП | WinForms | Игровая разработка | JSON | SOLID | Event-driven | Физика | Многопоточность | GDI+ | Паттерны проектирования | Сериализация
